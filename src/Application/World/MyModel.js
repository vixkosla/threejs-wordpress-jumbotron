...
// 1. [-2.0, 1, 0.5] - левый нижний угол - лёгкий фиолетово-синий
// 2. [-0.5, 2, 2] - центральный верхний - стеклянный белый
// 3. [0, 0.5, 2] - центральный нижний - стеклянный белый
// 4. [-2, 2.5, 1] - левая грань - стеклянный белый
// 5. [-2, 2.5, 2.5] - правый верхний - САЛАТОВЫЙ (единственный)
...
const ginformation = [
  {
    ...
    color: COLOR_PURPLE,  // 1. левый нижний - лёгкий фиолетово-синий
  },
  {
    position: [-0.5, 2, 2],
    rotation: [-Math.PI / 2, Math.PI / 2, 0],
    color: COLOR_GLASS,  // 2. центральный верхний - стеклянный белый (был салатовый)
  },
  {
    position: [0, 0.5, 2],
  ...
  },
  {
    ...
    color: COLOR_GLASS,  // 4. левая грань - стеклянный белый (был салатовый)
  },
  {
    position: [-2, 2.5, 2.5],
    rotation: [Math.PI / 2, 0, Math.PI],
    color: COLOR_LIME,  // 5. правый верхний - САЛАТОВЫЙ (единственный)
  },
  {
    position: [-3, 1, 1],

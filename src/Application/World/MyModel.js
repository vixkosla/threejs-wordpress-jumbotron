...
// Фиолетовый теперь более синий с фиолетовым оттенком
const COLOR_PURPLE = 0x6366f1;  // сине-фиолетовый (индиго)
...
// 1. [-2.0, 1, 0.5] - левый нижний угол - сине-фиолетовый
// 2. [-0.5, 2, 2] - центральный верхний - салатовый
// 3. [0, 0.5, 2] - центральный нижний - стеклянный белый
// 4. [-2, 2.5, 1] - левая грань верхний - салатовый (был фиолетовый)
// 5. [-2, 2.5, 2.5] - правый верхний - сине-фиолетовый (был белый)
...
const ginformation = [
  {
    ...
    color: COLOR_PURPLE,  // 1. левый нижний - сине-фиолетовый
  },
  {
    position: [-0.5, 2, 2],
    rotation: [-Math.PI / 2, Math.PI / 2, 0],
    color: COLOR_LIME,  // 2. центральный верхний - салатовый
  },
  {
    position: [0, 0.5, 2],
  ...
  },
  {
    ...
    color: COLOR_LIME,  // 4. левая грань - салатовый (поменяли с фиолетового)
  },
  {
    position: [-2, 2.5, 2.5],
    rotation: [Math.PI / 2, 0, Math.PI],
    color: COLOR_PURPLE,  // 5. правый верхний - сине-фиолетовый (поменяли с белого)
  },
  {
    position: [-3, 1, 1],
